...
\lstinputlisting[title={CMakeLists.txt principal},frame=single]{int/cmake-general.cmake}

El archivo de configuración de CMake para el directorio \cppid{sim} incluirá las
siguientes opciones:

\lstinputlisting[title={CMakeLists.txt para la biblioteca sim},frame=single]{int/sim.cmake}

El archivo de configuración de CMake para el directorio \cppid{fluid} incluirá las
siguientes opciones:

\lstinputlisting[title={CMakeLists.txt para programa fluid},frame=single]{int/fluid.cmake}
...
\lstinputlisting[title={CMakeLists.txt para pruebas unitarias},frame=single]{int/gtest.cmake}
